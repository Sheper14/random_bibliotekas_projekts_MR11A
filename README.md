...
"Random" ir viens no Python standarta bibliotēkām, kura ir iekļauta Python bez papildu instalācijas. Tā nodrošina vairākas metodes nejaušu skaitļu un izvēļu uzģenerēšanai. Šī bibliotēka tiek plaši izmantota visur, taču īpaši tiek pielietota spēļu izstrādē vai simulācijās. Es izvēlējos šo bibliotēku, jo tā piedāvā daudz un dažādas funkcijas, kuras nav grūti saprotamas un demonstrējamas. Izvēloties šo bibliotēku, vienlaikus iemācījos, ko jaunu, kā arī, iespējams, varu nodot šo informācijas apkopojumu citiem.
